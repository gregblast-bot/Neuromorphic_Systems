...
for l in range(6):
    ...
    # Plot the bar graph of energy/power level vs center frequency
    ax[l].bar(center_frequencies, energies)
    #ax[l].set_ylim(-1000, 60000)

ax[0].set_title('Energy/Power vs. Center Frequency')
ax[0].set_xlabel('Center Frequency (Hz)')
ax[2].set_ylabel('Energy/Power Level')
plt.show()